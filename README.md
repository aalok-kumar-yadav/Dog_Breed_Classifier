...
MODEL_NAME = 'dog_breed_inference_graph'
# Path to frozen detection graph. This is the actual model that is used for the object detection.
PATH_TO_FROZEN_GRAPH = MODEL_NAME + '/frozen_inference_graph.pb'

# List of the strings that is used to add correct label for each box.
PATH_TO_LABELS = os.path.join('dog_breed_inference_graph', 'dog_breed_classification.pbtxt')
...
![alt text](https://i.imgur.com/VnFjUBO.png)


![alt text](https://i.imgur.com/z87XHvu.png)

![alt text](https://i.imgur.com/ymNnOCW.png)
